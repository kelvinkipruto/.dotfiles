...
- Git and GitHub: docs/tools/git.md, docs/tools/gh.md
- History and navigation: docs/tools/atuin.md, docs/tools/zoxide.md
- Search and lists: docs/tools/rg.md, docs/tools/fd.md, docs/tools/fzf.md, docs/tools/eza.md
- Files and data: docs/tools/bat.md, docs/tools/jq.md
- System: docs/tools/htop.md
